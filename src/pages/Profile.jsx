...
import { getUserDetails, deleteUser } from '../kit/api/User'
...
export default function Profile() {
    ...
    const { authorized, setAuthorized, userDetails, setUserDetails } = useContext(DataContext)
